...
# impacts
title 'V-26543 - The system must be configured to audit Logon/Logoff - Special Logon successes.'
control 'V-26543' do
  impact 0.5
  ...
  tag 'stig', 'V-26543'
  tag severity: 'medium'
  tag checkid: 'C-47293r1_chk'
  tag fixid: 'F-45913r1_fix'
  tag version: 'WN12-AU-000053'
  tag ruleid: 'SV-52987r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Logon/Logoff -> "Audit Special Logon" with "Success" selected.'
...
# START_DESCRIBE V-26543
      describe file('') do
      it "is a pending example"
    end

# STOP_DESCRIBE V-26543

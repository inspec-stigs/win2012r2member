...
# impacts
title 'V-6833 - The Windows SMB server must be configured to always perform SMB packet signing.'
control 'V-6833' do
  impact 0.5
  ...
  tag 'stig', 'V-6833'
  tag severity: 'medium'
  tag checkid: 'C-47241r2_chk'
  tag fixid: 'F-45862r1_fix'
  tag version: 'WN12-SO-000032'
  tag ruleid: 'SV-52936r2_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Local Policies -> Security Options -> "Microsoft network server: Digitally sign communications (always)" to "Enabled".'

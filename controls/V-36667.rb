...
# impacts
title 'V-36667 - The system must be configured to audit Object Access - Removable Storage failures.'
control 'V-36667' do
  impact 0.5
  ...
  tag 'stig', 'V-36667'
  tag severity: 'medium'
  tag checkid: 'C-46854r1_chk'
  tag fixid: 'F-44725r1_fix'
  tag version: 'WN12-AU-000082'
  tag ruleid: 'SV-51604r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Object Access -> "Audit Removable Storage" with "Failure" selected.'

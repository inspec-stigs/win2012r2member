...
# impacts
title 'V-26530 - The system must be configured to audit Account Logon - Credential Validation failures.'
control 'V-26530' do
  impact 0.5
  ...
  tag 'stig', 'V-26530'
  tag severity: 'medium'
  tag checkid: 'C-47318r1_chk'
  tag fixid: 'F-45938r1_fix'
  tag version: 'WN12-AU-000002'
  tag ruleid: 'SV-53011r2_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Account Logon -> "Audit Credential Validation" with "Failure" selected.'

...
# impacts
title 'V-26536 - The system must be configured to audit Account Management - Security Group Management failures.'
control 'V-26536' do
  impact 0.5
  ...
  tag 'stig', 'V-26536'
  tag severity: 'medium'
  tag checkid: 'C-47312r1_chk'
  tag fixid: 'F-45932r1_fix'
  tag version: 'WN12-AU-000018'
  tag ruleid: 'SV-53005r2_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Account Management -> "Audit Security Group Management" with "Failure" selected.'

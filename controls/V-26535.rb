...
# impacts
title 'V-26535 - The system must be configured to audit Account Management - Security Group Management successes.'
control 'V-26535' do
  impact 0.5
  ...
  tag 'stig', 'V-26535'
  tag severity: 'medium'
  tag checkid: 'C-47314r1_chk'
  tag fixid: 'F-45934r1_fix'
  tag version: 'WN12-AU-000017'
  tag ruleid: 'SV-53007r2_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Account Management -> "Audit Security Group Management" with "Success" selected.'

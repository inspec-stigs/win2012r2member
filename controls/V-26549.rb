...
# impacts
title 'V-26549 - The system must be configured to audit Privilege Use - Sensitive Privilege Use successes.'
control 'V-26549' do
  impact 0.5
  ...
  tag 'stig', 'V-26549'
  tag severity: 'medium'
  tag checkid: 'C-47286r1_chk'
  tag fixid: 'F-45906r1_fix'
  tag version: 'WN12-AU-000101'
  tag ruleid: 'SV-52980r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Privilege Use -> "Audit Sensitive Privilege Use" with "Success" selected.'

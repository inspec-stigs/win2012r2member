...
# impacts
title 'V-26529 - The system must be configured to audit Account Logon - Credential Validation successes.'
control 'V-26529' do
  impact 0.5
  ...
  tag 'stig', 'V-26529'
  tag severity: 'medium'
  tag checkid: 'C-47320r1_chk'
  tag fixid: 'F-45940r1_fix'
  tag version: 'WN12-AU-000001'
  tag ruleid: 'SV-53013r2_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Account Logon -> "Audit Credential Validation" with "Success" selected.'
...
# START_DESCRIBE V-26529
      describe file('') do
      it "is a pending example"
    end

# STOP_DESCRIBE V-26529

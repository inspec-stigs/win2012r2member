...
# impacts
title 'V-26532 - The system must be configured to audit Account Management - Computer Account Management failures.'
control 'V-26532' do
  impact 0.5
  ...
  tag 'stig', 'V-26532'
  tag severity: 'medium'
  tag checkid: 'C-46973r1_chk'
  tag fixid: 'F-45250r1_fix'
  tag version: 'WN12-AU-000012'
  tag ruleid: 'SV-52235r3_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Account Management -> "Audit Computer Account Management" with "Failure" selected.'

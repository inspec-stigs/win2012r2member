...
# impacts
title 'V-26504 - Unauthorized accounts must not have the Restore files and directories user right.'
control 'V-26504' do
  impact 0.5
  ...
  tag 'stig', 'V-26504'
  tag severity: 'medium'
  tag checkid: 'C-46940r1_chk'
  tag fixid: 'F-45147r1_fix'
  tag version: 'WN12-UR-000040'
  tag ruleid: 'SV-52122r2_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Local Policies -> User Rights Assignment -> "Restore files and directories" to only include the following accounts or groups:
...
# START_DESCRIBE V-26504
      describe file('') do
      it "is a pending example"
    end

# STOP_DESCRIBE V-26504

...
# impacts
title 'V-26558 - The system must be configured to audit System - System Integrity failures.'
control 'V-26558' do
  impact 0.5
  ...
  tag 'stig', 'V-26558'
  tag severity: 'medium'
  tag checkid: 'C-47277r1_chk'
  tag fixid: 'F-45897r1_fix'
  tag version: 'WN12-AU-000112'
  tag ruleid: 'SV-52971r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> System -> "Audit System Integrity" with "Failure" selected.'
...
# START_DESCRIBE V-26558
      describe file('') do
      it "is a pending example"
    end

# STOP_DESCRIBE V-26558

...
# impacts
title 'V-26557 - The system must be configured to audit System - System Integrity successes.'
control 'V-26557' do
  impact 0.5
  ...
  tag 'stig', 'V-26557'
  tag severity: 'medium'
  tag checkid: 'C-47278r1_chk'
  tag fixid: 'F-45898r1_fix'
  tag version: 'WN12-AU-000111'
  tag ruleid: 'SV-52972r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> System -> "Audit System Integrity" with "Success" selected.'

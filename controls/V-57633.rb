...
# impacts
title 'V-57633 - The system must be configured to audit Policy Change - Authorization Policy Change successes.'
control 'V-57633' do
  impact 0.5
  ...
  tag 'stig', 'V-57633'
  tag severity: 'medium'
  tag checkid: 'C-58455r1_chk'
  tag fixid: 'F-62835r1_fix'
  tag version: 'WN12-AU-000089'
  tag ruleid: 'SV-72043r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Policy Change -> "Audit Authorization Policy Change" with "Success" selected.'
...
# START_DESCRIBE V-57633
      describe file('') do
      it "is a pending example"
    end

# STOP_DESCRIBE V-57633

...
# impacts
title 'V-26534 - The system must be configured to audit Account Management - Other Account Management Events failures.'
control 'V-26534' do
  impact 0.5
  ...
  tag 'stig', 'V-26534'
  tag severity: 'medium'
  tag checkid: 'C-47315r1_chk'
  tag fixid: 'F-45935r1_fix'
  tag version: 'WN12-AU-000016'
  tag ruleid: 'SV-53008r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Account Management -> "Audit Other Account Management Events" with "Failure" selected.'

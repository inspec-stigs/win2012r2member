...
# impacts
title 'V-40202 - The system must be configured to audit Object Access - Central Access Policy Staging successes.'
control 'V-40202' do
  impact 0.5
  ...
  tag 'stig', 'V-40202'
  tag severity: 'medium'
  tag checkid: 'C-46954r2_chk'
  tag fixid: 'F-45186r1_fix'
  tag version: 'WN12-AU-000059'
  tag ruleid: 'SV-52161r3_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> Object Access -> "Audit Central Access Policy Staging" with "Success" selected.'

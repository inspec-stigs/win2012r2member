...
# impacts
title 'V-26555 - The system must be configured to audit System - Security System Extension successes.'
control 'V-26555' do
  impact 0.5
  ...
  tag 'stig', 'V-26555'
  tag severity: 'medium'
  tag checkid: 'C-47280r1_chk'
  tag fixid: 'F-45900r1_fix'
  tag version: 'WN12-AU-000109'
  tag ruleid: 'SV-52974r1_rule'
  tag fixtext: 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Advanced Audit Policy Configuration -> System Audit Policies -> System -> "Audit Security System Extension" with "Success" selected.'

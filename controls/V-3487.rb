...
# impacts
title 'V-3487 - Necessary services must be documented to maintain a baseline to determine if additional, unnecessary services have been added to a system.'
control 'V-3487' do
  impact 0.5
  ...
  tag 'stig', 'V-3487'
  tag severity: 'medium'
  tag checkid: 'C-46963r2_chk'
  tag fixid: 'F-45237r1_fix'
  tag version: 'WN12-GE-000021'
  tag ruleid: 'SV-52218r2_rule'
  tag fixtext: 'Document the services required for the system to operate.  Remove or disable any services that are not required.'
  tag checktext: 'Required services will vary between organizations, and on the role of the individual system.  Organizations will develop their own list of services which will be documented and justified with the ISSO.  The sites list will be provided for any security review.  Services common to multiple systems can be addressed in one document.  Exceptions for individual systems should be identified separately by system.
